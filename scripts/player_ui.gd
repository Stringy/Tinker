...
func set_hunger(new_hunger, change):
	_set_stat_ui($Container/Player/Stats/Hunger, "Hunger", new_hunger, change)

func set_thirst(new_thirst, change):
	_set_stat_ui($Container/Player/Stats/Thirst, "Thirst", new_thirst, change)

func set_health(new_health, change):
	_set_stat_ui($Container/Player/Stats/Health, "Health", new_health, change)
